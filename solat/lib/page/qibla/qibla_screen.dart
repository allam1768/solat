                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(() {
                          ...
                          final isNearQibla = (rotation <= 2 ||
                              rotation >= 358); // toleransi 2 max
                        ...
                        // Himbauan Kalibrasi (Hanya muncul jika sensor tidak akurat)
                        Obx(() {
                          if (!controller.needsCalibration.value) {
                            return const SizedBox.shrink();
                          }
                          return Container(
...
class QiblaNeedlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.rotate(rotationAngle * 3.141592653589793 / 180);
    canvas.translate(-center.dx, -center.dy);
